...
class CatScreen extends GetView<PetsController> {
                                    ...
                                    children: [
                                      ...
                                      Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              "${controller.catList[i].weight.toString()}KG",
                                              style: const TextStyle(
                                ...
                                Align(
                                  ...
                                  child: Container(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsets.all(4.0),
                                        child: Text(
                                          "${controller.catList[i].age.toString()} Years",
